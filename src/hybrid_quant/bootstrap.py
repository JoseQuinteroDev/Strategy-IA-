...
def build_application_from_settings(settings: Settings) -> TradingApplication:
    ...
    deterministic_feature_config = DeterministicFeatureConfig(
        ...
        trend_pullback_pullback_lookback_bars=settings.strategy.pullback_lookback_bars,
        trend_pullback_trigger_lifetime_bars=settings.strategy.trigger_lifetime_bars,
        trend_pullback_trigger_breakout_lookback_bars=settings.strategy.trigger_breakout_lookback_bars,
        trend_pullback_stop_m1_lookback_bars=settings.strategy.stop_m1_lookback_bars,
        trend_pullback_stop_m5_lookback_bars=settings.strategy.stop_m5_lookback_bars,
        trend_pullback_stop_buffer_atr=settings.strategy.stop_buffer_atr,
        trend_pullback_maximum_vwap_distance_atr=settings.strategy.maximum_vwap_distance_atr,
    )
    feature_pipeline = FeaturePipeline(
    ...
    risk_engine = PropFirmRiskEngine(
        ...
        max_consecutive_losses_per_day=settings.risk.max_consecutive_losses_per_day,
        ...
        session_end_hour_utc=settings.risk.session_end_hour_utc,
        session_end_minute_utc=settings.risk.session_end_minute_utc,
        session_timezone=settings.risk.session_timezone,
        session_windows=settings.risk.session_windows,
